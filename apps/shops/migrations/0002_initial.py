    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="orders.ShopService", to="orders.service"
            ),
        ),
        migrations.AddField(
            model_name="commerce",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("full_price__gte", models.F("price"))),
                name="check_full_price",
            ),
        ),
    ]
