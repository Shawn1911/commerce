    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(max_length=150, verbose_name="Tavsif"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_name",
                    models.CharField(
                        blank=True, max_length=150, verbose_name="Familiya"
                    ),
                ),
                (
                    "email",
                    models.EmailField(blank=True, max_length=254, verbose_name="Eamil"),
                ),
                ("is_staff", models.BooleanField(default=False)),
                ("is_active", models.BooleanField(default=False)),
                (
                    "public_offer",
                    models.BooleanField(default=False, verbose_name="Ommaviy taklif"),
                ),
                (
                    "invitation_code",
                    models.CharField(
                ...
                (
                    "language",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="shops.language"
                    ),
                ),
                (
                    "user_permissions",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="da toʻlangan"
                    ),
                ),
                (
                    "pay_url",
                    models.URLField(blank=True, null=True, verbose_name="tolov url"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "original_price",
                    models.PositiveIntegerField(verbose_name="Haqiqiy narxi"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quotas",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="users.quotas"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, through="users.PlanQuotas", to="users.quotas"
            ),
        ),
        migrations.CreateModel(
            name="ShopUser",
